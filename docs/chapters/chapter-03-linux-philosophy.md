...
<img src="{{ '/assets/images/diagrams/chapter-03/pipe-processing-flow.svg' | relative_url }}" alt="パイプ処理の流れ図" style="width: 100%; max-width: 600px; height: auto;">
...
<img src="{{ '/assets/images/diagrams/chapter-03/kernel-userland-architecture.svg' | relative_url }}" alt="Linuxカーネル・ユーザーランドアーキテクチャ" style="width: 100%; max-width: 700px; height: auto;">
