...
これは、Linux 初心者が必ず抱く疑問です。スマートフォンやタブレットが当たり前の時代に、文字だけの黒い画面（ターミナル）で作業する。そう聞くと、時代遅れに見えるかもしれません。
...
GUI では「あのとき、どうやったっけ？」となりがちですが、CUI なら完全に再現できます。
...
サーバー管理では、24時間365日、人間が画面を見ているわけにはいきません。
