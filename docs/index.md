...
> 初めて Linux を触る読者は、まず [読者向けクイックスタート](quick-start/) を 20〜30 分で試してください。検証用の disposable 環境で、状態を壊さずに OS・ファイル・プロセス・ネットワークの観察を体験できます。
...
- **[クイックスタート](quick-start/)** - 安全な検証環境で Linux の基本観察を体験する
