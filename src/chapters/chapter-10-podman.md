...
2013年、Docker の登場によりコンテナ技術は爆発的に普及しました。しかし、エンタープライズ環境での利用が進むにつれ、いくつかの課題が明らかになってきました。
...
Podman は、コンテナを管理するためのツールでありながら、従来のコンテナ管理（特に Docker）が抱えていた課題を解決するために登場しました。
